...
GravatarImageTag.configure do |config|
  config.default_image           = "https://dl.dropboxusercontent.com/u/17219662/player.png"   # Set this to use your own default gravatar image rather then serving up Gravatar's default image [ 'http://example.com/images/default_gravitar.jpg', :identicon, :monsterid, :wavatar, 404 ].
